...
export const UNIVERSITY_DIRECTORY_DATA: UniversityDirectoryItem[] = [
  ...
  },
  {
    ...
    programCount: 330,
    description:
      "NUS is Asia's flagship institution, blending liberal education with cutting-edge research and global industry partnerships.",
    focusAreas: ["Engineering", "Computing", "Business", "Public Policy", "Medicine"],
    notablePrograms: ["Computer Science", "NUS MBA", "Public Policy"],
    badges: ["Top Asian University", "Entrepreneurial"],
    website: "https://www.nus.edu.sg",
    averageTuitionInternational: 30000,
    tuitionDisplay: "S$30k–S$38k per year (international)",
    studentBody: {
      total: 41000,
      internationalPercentage: 27,
    },
    researchHighlights: [
      "NUS Enterprise and BLOCK71 startup ecosystem",
      "Smart Nation and sustainability research initiatives",
    ],
    employabilityRank: 9,
  },
  {
