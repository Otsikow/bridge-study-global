...
const marketingCollateral = [
  {
    id: "program-playbook",
    title: "Global Program Match Playbook",
    description: "Co-branded brochure that highlights top-performing programs and includes talking points for parent calls.",
    format: "PDF",
    updated: "2 weeks ago",
...
const trainingModules = [
  {
    ...
    progress: 65,
    description: "Use the CRM to build shortlists and recommend best-fit programs using interest signals.",
  },
  {
    id: "conversion",
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Download ready-to-use assets to promote programs and nurture leads across every channel.
          </CardDescription>
        </CardHeader>
