          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="hidden text-left leading-tight md:block">
                <div className="font-semibold text-slate-900 dark:text-slate-100">{profile?.full_name ?? "UDX Partner"}</div>
          ...
          <DropdownMenuContent className="w-60 bg-white text-slate-900 shadow-lg dark:bg-slate-900 dark:text-slate-100">
            <DropdownMenuLabel>
              <div className="space-y-1">
                <p className="text-sm font-semibold">{profile?.full_name ?? "UDX Partner"}</p>
