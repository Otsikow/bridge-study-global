...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center gap-1.5 rounded-lg bg-card border border-border p-1 text-muted-foreground overflow-x-auto scrollbar-hide shadow-sm backdrop-blur-sm",
      className,
    )}
    {...props}
  />
