...
export const JourneyRibbon = () => {
  ...
  return (
    <div className="relative mx-auto mt-8 sm:mt-12 lg:mt-16 max-w-7xl px-4 sm:px-6">
      ...
      <div className="relative grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 md:gap-6 lg:grid-cols-3 xl:grid-cols-5">
        {segments.map((segment, index) => (
          <div key={segment.key} className="relative">
            ...
            <div
              className={`group relative flex h-full min-h-[280px] flex-col overflow-hidden rounded-2xl bg-gradient-to-br p-5 text-left text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl active:scale-[0.98] sm:min-h-[300px] sm:rounded-3xl sm:p-6 ${segment.gradient}`}
            >
