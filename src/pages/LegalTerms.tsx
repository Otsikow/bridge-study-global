...
const sections: Section[] = [
  {
    ...
    content: (
      <p>
        These Terms of Service ("Terms") govern your access to and use of UniDoxia ("UDX", "we",
  ...
  },
  {
    ...
    content: (
      <p>
        You retain ownership of content you submit to the Services. You grant UDX a worldwide, non-exclusive,
  ...
  },
  {
    ...
    content: (
      <p>
        UDX facilitates connections between students, agents, and educational institutions but does not control
  ...
  },
  {
    ...
    content: (
      <p>
        To the maximum extent permitted by law, UDX and its affiliates will not be liable for any indirect, incidental,
  ...
  },
  {
    ...
    content: (
      <p>
        You agree to defend, indemnify, and hold harmless UDX, its affiliates, and their respective officers, directors,
  ...
  },
  {
    ...
    content: (
      <p>
        These Terms are governed by the laws of the jurisdiction in which UDX is established, without regard to its
