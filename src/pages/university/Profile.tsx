...
const profileSchema = z.object({
  ...
  description: z
    .string()
    .min(30, "Share at least a couple of sentences about your university")
    .max(2000, "Keep your description concise"),
  ...
  highlights: z
    .array(
      z
        .string()
        .trim()
        .min(3, "Highlight cannot be empty")
        .max(160, "Keep highlights short and impactful"),
    )
...
const UniversityProfilePage = () => {
  ...
  useEffect(() => {
    ...
    const { university, details } = queryData;
    ...
    form.reset({
      ...
      contactName:
        details.contacts.primary?.name ?? profile?.full_name ?? "",
      contactTitle: details.contacts.primary?.title ?? "",
      contactEmail:
        details.contacts.primary?.email ?? profile?.email ?? "",
      contactPhone:
        details.contacts.primary?.phone ?? profile?.phone ?? "",
      highlights:
        details.highlights.length > 0 ? details.highlights : [""],
      social: {
    ...
    const hero =
      details.media.heroImageUrl ?? university?.featured_image_url ?? null;
  ...
  const onSubmit = async (values: UniversityProfileFormValues) => {
    ...
    try {
      ...
      let heroUrl =
        queryData?.details.media.heroImageUrl ??
        queryData?.university?.featured_image_url ??
        null;
      if (heroFile) {
      ...
      toast({
        ...
        description:
          ...
          "Please try again or contact your partnership manager.",
        variant: "destructive",
      });
    } finally {
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              Craft a compelling profile that appears across the Global
              Education Gateway for agents and students.
            </p>
          </div>
        </div>
              ...
              <form className="space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Share your mission, standout faculties, research focus and student community."
                ...
                <section className="space-y-6" id="profile-step-2">
                  ...
                  <div className="space-y-3">
                    {highlightsFieldArray.fields.map((highlight, index) => (
                      <div
                        key={highlight.id}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex-1">
                              ...
                              <FormControl>
                                <Input
                                  placeholder="Top 5 globally for graduate employability"
                                  {...field}
                                />
                              </FormControl>
                              <FormMessage />
                    ...
                    {highlightsFieldArray.fields.length < 5 ? (
                      <Button
                        type="button"
                        variant="secondary"
                        size="sm"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-4">
                        <Avatar className="h-20 w-20 border border-dashed border-muted-foreground/40 bg-muted">
                          {logoPreview ? (
                            <AvatarImage src={logoPreview} alt="University logo preview" />
                          ) : (
                            <AvatarFallback>
