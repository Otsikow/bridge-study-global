    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Manage your published courses and control which ones are visible to UDX agents and students.
        </p>
      </div>
      ...
      <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
        <DialogContent className="max-h-[90vh] overflow-y-auto border border-border bg-background text-card-foreground sm:max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Publish a new course to make it available to agents and students across the UDX ecosystem.
            </DialogDescription>
          </DialogHeader>
          <ProgramForm
