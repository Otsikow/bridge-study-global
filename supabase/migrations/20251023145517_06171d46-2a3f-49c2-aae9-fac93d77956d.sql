-- Apply the user_roles migration to fix privilege escalation vulnerability
-- This migration creates a separate user_roles table with proper RLS policies

-- Note: This is the same migration that already exists in the codebase
-- but has not been applied to the database yet
